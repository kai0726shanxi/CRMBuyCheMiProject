 ...
 */
class ChoseTypeDialog : Dialog,View.OnClickListener {
    ...
    private fun initView(mcontext: Context) {
        convertView = LayoutInflater.from(mcontext).inflate(R.layout.layout_dialog_chosetype, null, false)
    ...
    override fun onClick(v: View?) {
        dismiss()
        when(v?.id){
            R.id.rb1-> mOnclick!!.btndata("日报")
            R.id.rb2-> mOnclick!!.btndata("周报")
            R.id.rb3-> mOnclick!!.btndata("月报")
